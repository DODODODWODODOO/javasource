...
public class CheckingAccountEx {
  ...
  public static void main(String[] args) {
    ...
    // }
    // try {
    //   cTrafficCardAccount.payTrafficCard(null, 0);
    // } catch (Exception e) {
    //   e.printStackTrace();
    // }
    ...
    // );
    // try {
    //   cTrafficCardAccount2.payTrafficCard("111-12", 1800);
    //   System.out.println("현재 잔액" + cTrafficCardAccount2.getBalance());
    // } catch (Exception e) {
    //
    //   e.printStackTrace();
    // }
    // try {
    //   cTrafficCardAccount2.payTrafficCard(null, 0);
    // } catch (Exception e) {
    //
    //   e.printStackTrace();
    // }
    ...
    BounsPointAccount bounsPointAccount = new BounsPointAccount(
      "110-12",
      "이순신",
      0,
      0
    );
    bounsPointAccount.deposit(100000);
    System.out.printf(
      "%s 님의 보너스 포인트는 %d\n",
      bounsPointAccount.getOwner(),
      bounsPointAccount.getBounsPoint()
    );
  }
}
